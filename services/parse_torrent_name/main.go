...
var sportMatcher = NewRegexpMatcher(
	...
	// quotes match. Inter-token separator is `[\s.\-]+` (not bare
	// `\s+`) so the hyphenated torrent shape "giro-d'italia-stage-
	// NN-highlights" matches too — weekly skip-list mining 2026-05-18
