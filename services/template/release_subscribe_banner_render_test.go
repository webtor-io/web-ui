...
func TestReleaseSubscribeBannerRenders(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		},
		{
			...
			want:    []string{"/subscription/add", `name="season" value="3"`, "resource_banner", "release_sub.btn_subscribe"},
		...
		},
		{
			...
			want:    []string{"/subscription/delete/8c1f0d24-0000-0000-0000-000000000000", "release_sub.btn_unsubscribe"},
		...
		},
		{
			...
			want:    []string{"/login?return-url=%2fabc123", "release_sub.btn_subscribe"},
