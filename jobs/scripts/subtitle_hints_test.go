...
func TestSubtitleHintsPrefersEmbedSetting(t *testing.T) {
	h := subtitleHints("tt0000001", &models.VideoMetadata{VideoID: "tt0000002"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.2020.1080p.mkv"}, nil, false)
...
func TestSubtitleHintsEmbedSettingKeepsEpisodeAndIgnoresContentType(t *testing.T) {
	h := subtitleHints("tt0903747", nil, "", &ra.ListItem{PathStr: "/Breaking.Bad.S01/Breaking.Bad.S01E03.1080p.mkv"}, nil, false)
...
func TestSubtitleHintsFromEnrichment(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0109424"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.2020.1080p.mkv"}, nil, false)
...
func TestSubtitleHintsIgnoresTmdbOnlyID(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tmdb12345"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.mkv"}, nil, false)
	if h.ImdbID != "" {
...
func TestSubtitleHintsEpisodeFromPath(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Breaking.Bad.S01/Breaking.Bad.S01E03.1080p.mkv"}, nil, false)
	if h.ImdbID != "tt0903747" || h.Season != 1 || h.Episode != 3 {
		t.Fatalf("got %+v", h)
	}
}
...
func TestSubtitleHintsSeriesWithoutSeasonSendsNothing(t *testing.T) {
	...
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Show/Show - 03 - title.mkv"}, nil, false)
...
func TestSubtitleHintsSeasonFolderLayout(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Season 1/Show - 03 - title.mkv"}, nil, false)
	if h.ImdbID != "tt0903747" || h.Season != 1 || h.Episode != 3 {
...
func TestSubtitleHintsPreferThePersistedRef(t *testing.T) {
	...
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Show/S01E03.mkv"}, ref, false)
	...
	h = subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.S01E01.Special.mkv"}, movie, false)
	...
	h = subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.mkv"}, synth, false)
	...
	h = subtitleHints("tt3333333", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Show/S01E03.mkv"}, ref, false)
...
func TestSubtitleHintsSeriesWithMovieLikePathSendsNothing(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0903747"}, models.ContentTypeSeries, &ra.ListItem{PathStr: "/Some.Extra.Feature.1080p.mkv"}, nil, false)
	if h.ImdbID != "" || h.Season != 0 || h.Episode != 0 {
...
func TestSubtitleHintsMovieNeverSendsSeasonEpisode(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0109424"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.S01E01.mkv"}, nil, false)
	if h.ImdbID != "tt0109424" || h.Season != 0 || h.Episode != 0 {
		t.Fatalf("got %+v", h)
	}
}
...
func TestSubtitleHintsNilSafe(t *testing.T) {
	h := subtitleHints("", nil, "", nil, nil, false)
	if h.ImdbID != "" || h.Season != 0 || h.Episode != 0 {
		t.Fatalf("got %+v", h)
	}
}
...
func TestSubtitleHintsWithoutContentTypeSendsNothing(t *testing.T) {
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0109424"}, "", &ra.ListItem{PathStr: "/Movie.2020.1080p.mkv"}, nil, false)
	if h.ImdbID != "" {
		t.Fatalf("got %+v", h)
	}
}

func TestSubtitleHintsAdultSendsNothingDerived(t *testing.T) {
	ref := &models.VideoRef{Kind: models.VideoRefKindMovie, VideoID: "tt2222222"}
	h := subtitleHints("", &models.VideoMetadata{VideoID: "tt0111161"}, models.ContentTypeMovie, &ra.ListItem{PathStr: "/Movie.mkv"}, ref, true)
	if h.ImdbID != "" || h.Season != 0 || h.Episode != 0 {
		t.Fatalf("an adult resource must not be named to OpenSubtitles: %+v", h)
	}
	// The embedder's own declaration passes through untouched.
