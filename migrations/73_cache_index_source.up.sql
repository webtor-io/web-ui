...
-- differently.
--
--   probe   somebody asked the backend at play time ("is it cached?") and it
...
--   seeder  the seeder reported the file complete on its disk
...
ALTER TABLE public.cache_index
	ADD COLUMN source text NOT NULL DEFAULT 'probe';
